...
- 流程图
  ...
  ![流程图](https://p.ipic.vip/m1o5lv.png)

- 小程序架构

  ![小程序架构1](https://p.ipic.vip/tqv8e6.png)

- [学习笔记](https://github.com/RicardoPang/pf-wxapp-unpacker/blob/main/note.md)
- [微信小程序的技术架构与运行原理解析](https://ricardopang.github.io/components/program.html)
